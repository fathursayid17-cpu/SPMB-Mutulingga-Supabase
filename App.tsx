...
// Data Kecamatan Lengkap untuk BARLINGMASCAKEB (Fokus: Purbalingga, Banyumas, Banjarnegara)
const KECAMATAN_MAP: Record<string, string[]> = {
  // PURBALINGGA (18 Kecamatan)
  'Purbalingga': [
    'Purbalingga', 'Kalimanah', 'Padamara', 'Kutasari', 'Bojongsari', 
    'Mrebet', 'Bobotsari', 'Karangreja', 'Karangjambu', 'Karanganyar', 
    'Kertanegara', 'Karangmoncol', 'Rembang', 'Pengadegan', 'Kaligondang', 
    'Kejobong', 'Bukateja', 'Kemangkon'
  ],
  
  // BANYUMAS (27 Kecamatan)
  'Banyumas': [
    'Purwokerto Utara', 'Purwokerto Selatan', 'Purwokerto Barat', 'Purwokerto Timur', 
    'Baturraden', 'Sokaraja', 'Kembaran', 'Sumbang', 'Kedungbanteng', 'Karanglewas', 
    'Cilongok', 'Ajibarang', 'Pekuncen', 'Gumelar', 'Lumbir', 'Wangon', 'Jatilawang', 
    'Rawalo', 'Kebasen', 'Patikraja', 'Purwojati', 'Kalibagor', 'Banyumas', 'Somagede', 
    'Kalibagor', 'Tambak', 'Sumpiuh'
  ],

  // BANJARNEGARA (20 Kecamatan)
  'Banjarnegara': [
    'Banjarnegara', 'Sigaluh', 'Madukara', 'Banjarmangu', 'Wanadadi', 
    'Rakit', 'Punggelan', 'Mandiraja', 'Purwareja Klampok', 'Susukan', 
    'Kalibening', 'Pandanarum', 'Karangkobar', 'Pagentan', 'Pejawaran', 
    'Batur', 'Wanayasa', 'Kalibening', 'Pezawaran', 'Bawang'
  ],
};

// Data Desa/Kelurahan (Lengkap untuk Kecamatan yang diminta agar Auto Kode Pos Berjalan)
const DESA_MAP: Record<string, string[]> = {
  // --- KEC. PURBALINGGA ---
  'Purbalingga': [
    'Bancar', 'Bojong', 'Jatisaba', 'Kandanggampang', 'Kedung Menjangan', 
    'Kembaran Kulon', 'Penambongan', 'Purbalingga Kidul', 'Purbalingga Kulon', 
    'Purbalingga Lor', 'Purbalingga Wetan', 'Toyareka', 'Wirasana'
  ],
  
  // --- KEC. KALIMANAH ---
  'Kalimanah': [
    'Babakan', 'Blater', 'Grecol', 'Jompo', 'Kalimanah Kulon', 
    'Kalimanah Wetan', 'Karangpetir', 'Karangsar', 'Kedungwuluh', 
    'Klapa Sawit', 'Manduraga', 'Mewek', 'Rabak', 'Selabaya', 'Sidakangen'
  ],

  // --- KEC. PADAMARA ---
  'Padamara': [
    'Bojong', 'Dawuhan', 'Gemuruh', 'Kalitinggar', 'Kalitinggar Kidul', 
    'Karanggambas', 'Karangjambe', 'Karangpule', 'Karangsentul', 'Mipiran', 
    'Padamara', 'Prigi', 'Purbayasa', 'Sokawera'
  ],

  // --- KEC. KUTASARI ---
  'Kutasari': [
    'Candinata', 'Candiwulan', 'Cendana', 'Karangaren', 'Karangcegak', 
    'Karangjengkol', 'Karangklesem', 'Karangreja', 'Kekep', 'Kutasari', 
    'Limbangan', 'Meri', 'Munjul', 'Sumingkir'
  ],

  // --- KEC. BOBOTSARI ---
  'Bobotsari': [
    'Banjarsari', 'Bobotsari', 'Dagan', 'Gandasuli', 'Gunungkarang', 
    'Kalapacung', 'Karangduren', 'Karangmalang', 'Karangtalun', 'Lajer', 
    'Limbangan', 'Majapura', 'Pakuncen', 'Palumbungan', 'Palumbungan Wetan', 
    'Talagening', 'Tlagayasa'
  ],

  // --- KEC. BUKATEJA ---
  'Bukateja': [
    'Bajong', 'Bukateja', 'Cipawon', 'Karangcengis', 'Karanggedang', 
    'Karangnangka', 'Kebutuh', 'Kedungjati', 'Kembangan', 'Kutawis', 
    'Majasari', 'Penaruban', 'Tidu', 'Wirasaba'
  ],

  // --- KEC. KEMANGKON ---
  'Kemangkon': [
    'Bakulan', 'Bokol', 'Gambarsari', 'Jetis', 'Kalialang', 'Karangkemiri', 
    'Karangtengah', 'Kedungbenda', 'Kedunglegok', 'Kemangkon', 'Majasem', 
    'Majatengah', 'Muntang', 'Panican', 'Pegandekan', 'Pelumutan', 'Senon', 
    'Sumilir', 'Toyareka'
  ],
  
  // --- KEC. SOKARAJA (BANYUMAS) ---
...
const KODEPOS_MAP: Record<string, string> = {
  // --- KEC. PURBALINGGA (5331x) ---
  'Purbalingga Lor': '53311', 'Purbalingga Kulon': '53312', 'Purbalingga Kidul': '53313', 
  'Bancar': '53314', 'Kembaran Kulon': '53315', 'Penambongan': '53316', 
  'Purbalingga Wetan': '53317', 'Wirasana': '53318', 
  'Kandanggampang': '53319', 'Kedung Menjangan': '53319', 'Toyareka': '53319', 'Bojong': '53319', 'Jatisaba': '53319',

  // --- KEC. KALIMANAH (53371) ---
  'Kalimanah Wetan': '53371', 'Kalimanah Kulon': '53371', 'Blater': '53371', 'Grecol': '53371',
  'Jompo': '53371', 'Karangpetir': '53371', 'Klapa Sawit': '53371', 'Manduraga': '53371', 
  'Mewek': '53371', 'Selabaya': '53371', 'Sidakangen': '53371', 'Babakan': '53371', 
  'Kedungwuluh': '53371', 'Karangsar': '53371', 'Rabak': '53371',

  // --- KEC. PADAMARA (53372) ---
  'Padamara': '53372', 'Gemuruh': '53372', 'Kalitinggar': '53372', 'Kalitinggar Kidul': '53372', 
  'Karangjambe': '53372', 'Karangpule': '53372', 'Mertani': '53372', 'Purbayasa': '53372', 
  'Sokawera': '53372', 'Prigi': '53372', 'Dawuhan': '53372', 'Karanggambas': '53372',
  'Karangsentul': '53372', 'Mipiran': '53372',

  // --- KEC. KUTASARI (53361) ---
  'Kutasari': '53361', 'Candinata': '53361', 'Candiwulan': '53361', 'Cendana': '53361', 
  'Karangaren': '53361', 'Karangcegak': '53361', 'Karangjengkol': '53361', 'Karangklesem': '53361', 
  'Kekep': '53361', 'Karangreja': '53361', 'Sumingkir': '53361', 'Meri': '53361', 
  'Limbangan': '53361', 'Munjul': '53361',

  // --- KEC. BOBOTSARI (53353) ---
  'Bobotsari': '53353', 'Dagan': '53353', 'Gandasuli': '53353', 'Gunungkarang': '53353', 
  'Kalapacung': '53353', 'Karangduren': '53353', 'Karangmalang': '53353', 'Karangtalun': '53353', 
  'Lajer': '53353', 'Majapura': '53353', 'Pakuncen': '53353', 'Palumbungan': '53353', 
  'Palumbungan Wetan': '53353', 'Tlagayasa': '53353', 'Talagening': '53353', 'Banjarsari': '53353',

  // --- KEC. BUKATEJA (53382) ---
  'Bukateja': '53382', 'Bajong': '53382', 'Cipawon': '53382', 'Karangcengis': '53382', 
  'Karanggedang': '53382', 'Karangnangka': '53382', 'Kebutuh': '53382', 'Kedungjati': '53382', 
  'Kembangan': '53382', 'Kutawis': '53382', 'Majasari': '53382', 'Penaruban': '53382', 
  'Tidu': '53382', 'Wirasaba': '53382',

  // --- KEC. KEMANGKON (53381) ---
  'Kemangkon': '53381', 'Bakulan': '53381', 'Bokol': '53381', 'Gambarsari': '53381', 
  'Jetis': '53381', 'Kalialang': '53381', 'Karangtengah': '53381', 'Kedungbenda': '53381', 
  'Kedunglegok': '53381', 'Majasem': '53381', 'Majatengah': '53381', 'Muntang': '53381', 
  'Panican': '53381', 'Pegandekan': '53381', 'Pelumutan': '53381', 'Senon': '53381', 
  'Sumilir': '53381', 'Karangkemiri': '53381'
};
...
const getDbKey = (year: string) => `mts_pendaftaran_db_${year.replace('/', '_')}`;
...
const App: React.FC = () => {
  ...
  const [state, setState] = useState<AppState>(() => {
    ...
    const dbKey = getDbKey(lastSelectedYear);
    const savedDb = localStorage.getItem(dbKey);
    const allRegistrants = savedDb ? JSON.parse(savedDb) : [];
    
    return {
      viewMode: 'landing', 
      currentStep: 'inden', 
      selectedYear: lastSelectedYear,
      studentData: { ...FULL_EMPTY_STUDENT_DATA, tahunAjaran: lastSelectedYear, noUrut: (allRegistrants.length + 1).toString() },
      errors: {}, 
      isSubmitting: false, 
      isFinished: false, 
      aiAnalysis: null,
  ...
  useEffect(() => {
    const dbKey = getDbKey(state.selectedYear);
    const savedDb = localStorage.getItem(dbKey);
    const allRegistrants = savedDb ? JSON.parse(savedDb) : [];
    setState(prev => ({ 
      ...prev, 
      allRegistrants,
      studentData: { ...prev.studentData, tahunAjaran: state.selectedYear, noUrut: (allRegistrants.length + 1).toString() }
    }));
  ...
  const LogoComponent = ({ size = "md", isBlackAndWhite = false, interactive = true }: { size?: "sm" | "md" | "lg", isBlackAndWhite?: boolean, interactive?: boolean }) => {
    ...
    return (
      ...
      >
        <img 
          src={schoolLogo || DEFAULT_LOGO} 
          alt="School Logo" 
          className={`w-full h-full object-contain p-1.5 ${isBlackAndWhite ? 'print:grayscale' : ''}`} 
  ...
  const updateData = (fields: Partial<StudentData>) => {
    setState(prev => {
      ...
      if ('propinsi' in fields) {
        newStudentData.kabupaten = '';
        newStudentData.kecamatan = '';
        newStudentData.desaKelurahan = '';
        newStudentData.kodePos = '';
      }
      else if ('kabupaten' in fields) {
        newStudentData.kecamatan = '';
        newStudentData.desaKelurahan = '';
        newStudentData.kodePos = '';
      }
      else if ('kecamatan' in fields) {
        newStudentData.desaKelurahan = '';
        newStudentData.kodePos = '';
      }
      else if ('desaKelurahan' in fields) {
        newStudentData.kodePos = KODEPOS_MAP[fields.desaKelurahan!] || '';
      }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let updatedRegistrants = [...state.allRegistrants];
      if (state.editingIndex !== null) { updatedRegistrants[state.editingIndex] = newRegistrant; } 
      else { updatedRegistrants.push(newRegistrant); }
      localStorage.setItem(getDbKey(state.selectedYear), JSON.stringify(updatedRegistrants));
  ...
  const performDelete = () => {
    ...
    const updated = state.allRegistrants.filter((_, i) => i !== index);
    localStorage.setItem(getDbKey(state.selectedYear), JSON.stringify(updated));
  ...
  const exportToExcel = () => {
    ...
    // Mapping data sesuai urutan tabel SQL
    const dataToExport = state.allRegistrants.map((item, i) => {
        return {
          "id": `gen_random_uuid()`, // Placeholder for SQL
          "created_at": new Date().toISOString(),
          
          // -- DATA SISWA
          "nama_siswa": item.namaSiswa,
          "nis_lokal": item.nisLokal,
          "nisn": item.nisn,
          "nik": item.nik,
          "tempat_lahir": item.tempatLahir,
          "tanggal_lahir": item.tanggalLahir,
          "agama": item.agama,
          "warga_negara": item.wargaNegara,
          "jenis_kelamin": item.jenisKelamin,
          "hobi": item.hobi,
          "anak_ke": item.anakKe,
          "jumlah_saudara": item.jumlahSaudara,

          // -- ALAMAT & KONTAK
          "jenis_tempat_tinggal": item.jenisTempatTinggal,
          "alamat": item.alamat,
          ...
          "jarak_tempat_tinggal": item.jarakTempatTinggal,
          "transportasi": item.transportasi,
          "jarak_tempuh": item.jarakTempuh,

          // -- DATA KELUARGA (AYAH)
          "no_kk": item.noKK,
          "nama_kep_keluarga": item.namaKepKeluarga,
          "nama_ayah": item.namaAyah,
          "nik_ayah": item.nikAyah,
          "tempat_lahir_ayah": item.tempatLahirAyah,
          "tgl_lahir_ayah": item.tglLahirAyah,
          "status_ayah": item.statusAyah,
          "pekerjaan_ayah": item.pekerjaanAyah,
          "penghasilan_ayah_perbulan": item.penghasilanAyahPerbulan,
          "pendidikan_ayah": item.pendidikanAyah,
          
          // -- DATA KELUARGA (IBU)
          "nama_ibu": item.namaIbu,
          "nik_ibu": item.nikIbu,
          "tempat_lahir_ibu": item.tempatLahirIbu,
          "tgl_lahir_ibu": item.tglLahirIbu,
          "status_ibu": item.statusIbu,
          "pekerjaan_ibu": item.pekerjaanIbu,
          "penghasilan_ibu_perbulan": item.penghasilanIbuPerbulan,
          "pendidikan_ibu": item.pendidikanIbu,

          // -- DATA WALI
          "nama_wali_siswa": item.namaWali,
          "tahun_lahir_wali_siswa": item.tahunLahirWali,
          "nik_wali_siswa": item.nikWali,
          "pendidikan_wali_siswa": item.pendidikanWali,
          "pekerjaan_wali_siswa": item.pekerjaanWali,
          "penghasilan_wali_siswa": item.penghasilanWali,
          ...
          "pip": item.pip,
          "kip": item.kip,
          "status_kepemilikan_rumah_orang_tua": item.statusKepemilikanRumahOrangTua,

          // -- SEKOLAH ASAL
          "tahun_ajaran": item.tahunAjaran,
          "jenis_lembaga_jenjang": item.jenisLembagaJenjang,
          "status_sekolah_asal": item.statusSekolahAsal,
          "npsn_sekolah": item.npsnSekolah,
          "nama_sekolah_madrasah": item.namaSekolahMadrasah,
          "lokasi_sekolah": item.lokasiSekolah,
          "no_peserta_un": item.noPesertaUN,
          "no_blanko_skhu": item.noBlankoSKHU,
          "no_seri_ijazah": item.noSeriIjazah,
          "total_nilai_un": item.totalNilaiUN,

          // -- TAMBAHAN
          "pilihan_program": item.pilihanProgram,
          "foto_siswa": item.fotoSiswa ? "Image Data Present" : "",
          "no_urut": item.noUrut,
          "is_inden": item.isInden ? "TRUE" : "FALSE"
        };
    });
  ...
  const renderProgramCards = () => (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <label className="block text-slate-500 text-[10px] font-black uppercase tracking-tighter">
          <span className="text-maroon">#AuraCheck:</span> Pilih Program Pilihan Kamu
        </label>
        ...
        {PROGRAM_OPTIONS.map((prog) => {
          ...
          return (
            <button
              key={prog.id}
              type="button"
              onClick={() => updateData({ pilihanProgram: prog.id as any })}
              className={`relative overflow-hidden p-5 rounded-[28px] border-2 transition-all duration-500 flex flex-col items-start text-left group h-full ${
                isSelected 
                ? `${prog.color} bg-white/5 ${prog.glow} scale-[1.02] z-10` 
  ...
  const renderCascadingField = (label: string, field: keyof StudentData, options: string[]) => {
    ...
    // Jika value tidak kosong DAN tidak ada di list opsi, berarti ini input manual (Lainnya)
    const isManualInput = value !== '' && !options.includes(value);
    
    // Jika manual input, dropdown tampilkan "Lainnya". Jika value kosong, dropdown "". Jika ada di opsi, tampilkan value.
    ...
    return (
      <div className="mb-4 text-left animate-in fade-in duration-300">
        ...
        <div className="space-y-2">
          <select
            className={`w-full bg-slate-900/40 border ${state.errors[field] && !value ? 'border-red-500' : 'border-slate-800'} text-slate-100 rounded-2xl px-5 py-3.5 text-xs focus:outline-none transition-all appearance-none cursor-pointer`}
            value={dropdownValue}
            onChange={(e) => {
                const val = e.target.value;
                if (val === 'Lainnya') {
                   // Set ke karakter placeholder agar 'isManualInput' menjadi true, tapi field input muncul kosong
                   // Menggunakan spasi ' ' sebagai trigger input manual agar dropdown tetap di "Lainnya"
                   updateData({ [field]: ' ' }); 
                } else {
          ...
          {(dropdownValue === 'Lainnya') && (
            <input
              type="text"
              placeholder={`Ketik Nama ${label} Manual...`}
              className={`w-full bg-slate-800 border ${state.errors[field] ? 'border-red-500' : 'border-slate-600'} text-white rounded-2xl px-5 py-3.5 text-xs focus:outline-none animate-in slide-in-from-top-2 focus:ring-2 focus:ring-maroon placeholder:text-slate-500 font-medium`}
              value={value === ' ' ? '' : value}
              onChange={(e) => updateData({ [field]: e.target.value })}
              autoFocus
            />
    ...
    switch (adminFormStep) {
        ...
        <div className="animate-in fade-in slide-in-from-right-4">
          ...
          <div className="flex justify-center mb-8">
            <div 
              ...
              className="w-32 h-32 rounded-full bg-slate-900/40 border-2 border-dashed border-slate-700 flex flex-col items-center justify-center cursor-pointer hover:border-maroon hover:bg-maroon/10 transition-all overflow-hidden relative group"
            >
              {(state.studentData.fotoSiswa) ? (
                <img src={state.studentData.fotoSiswa} alt="Profile" className="w-full h-full object-cover" />
              ) : (
                <>
                  <Icons.User />
                  <span className="text-[8px] mt-2 uppercase font-bold text-slate-500">Upload Foto</span>
                </>
              )}
              <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <span className="text-[9px] text-white font-black uppercase tracking-widest">GANTI</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            {renderInput("Nama Siswa *", "namaSiswa")} {renderInput("NIS Lokal", "nisLokal")} {renderInput("NISN *", "nisn")}
            {renderInput("NIK", "nik")} {renderInput("Tempat Lahir", "tempatLahir")} {renderInput("Tanggal Lahir", "tanggalLahir", "date")}
            {renderSelect("Agama", "agama", ["Islam", "Kristen", "Katolik", "Hindu", "Budha", "Konghucu"])}
            {renderSelect("Jenis Kelamin", "jenisKelamin", ["Laki-laki", "Perempuan"])}
            {renderInput("Warga Negara", "wargaNegara")}
            
            {/* Tambahan Sesuai SQL */}
            {renderInput("Hobi", "hobi")}
            {renderInput("Anak Ke-", "anakKe")} {renderInput("Jumlah Saudara", "jumlahSaudara")}
          </div>
        </div>
      );
      case 1: 
        ...
        return (
          <div className="animate-in fade-in slide-in-from-right-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
              ...
              {renderCascadingField("Provinsi", "propinsi", PROVINSI_OPTIONS)}
              {renderCascadingField("Kabupaten", "kabupaten", kabOptions)}
              {renderCascadingField("Kecamatan", "kecamatan", kecOptions)}
              {renderCascadingField("Desa/Kelurahan", "desaKelurahan", desaOptions)}
              {renderInput("Kode Pos", "kodePos")}
              {renderInput("WhatsApp Aktif *", "nomorTelepon", "tel")}
              {renderSelect("Transportasi", "transportasi", ["Jalan Kaki", "Sepeda", "Motor", "Mobil Pribadi", "Antar Jemput", "Angkutan Umum"])}
              {renderSelect("Jarak ke Sekolah", "jarakTempatTinggal", ["Kurang dari 1 km", "1 - 5 km", "5 - 10 km", "Lebih dari 10 km"])}
      ...
      case 2: return (
        <div className="animate-in fade-in slide-in-from-right-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            {renderInput("No. Kartu Keluarga", "noKK")} {renderInput("Nama Kepala Keluarga", "namaKepKeluarga")}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            {renderInput("Nama Ayah", "namaAyah")} {renderInput("NIK Ayah", "nikAyah")}
            {renderInput("Tempat Lahir Ayah", "tempatLahirAyah")} {renderInput("Tgl Lahir Ayah", "tglLahirAyah", "date")}
            {renderSelect("Status Ayah", "statusAyah", ["Masih Hidup", "Meninggal Dunia", "Bercerai"])}
            {renderSelect("Pekerjaan Ayah", "pekerjaanAyah", PEKERJAAN_OPTIONS)}
            {renderSelect("Penghasilan Ayah", "penghasilanAyahPerbulan", PENDAPATAN_OPTIONS)}
            {renderSelect("Pendidikan Ayah", "pendidikanAyah", PENDIDIKAN_OPTIONS)}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            {renderInput("Nama Ibu", "namaIbu")} {renderInput("NIK Ibu", "nikIbu")}
            {renderInput("Tempat Lahir Ibu", "tempatLahirIbu")} {renderInput("Tgl Lahir Ibu", "tglLahirIbu", "date")}
            {renderSelect("Status Ibu", "statusIbu", ["Masih Hidup", "Meninggal Dunia", "Bercerai"])}
            {renderSelect("Pekerjaan Ibu", "pekerjaanIbu", PEKERJAAN_OPTIONS)}
            {renderSelect("Penghasilan Ibu", "penghasilanIbuPerbulan", PENDAPATAN_OPTIONS)}
            {renderSelect("Pendidikan Ibu", "pendidikanIbu", PENDIDIKAN_OPTIONS)}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            ...
            {renderInput("Tahun Lahir Wali", "tahunLahirWali", "number")}
            {renderSelect("Pekerjaan Wali", "pekerjaanWali", PEKERJAAN_OPTIONS)}
            {renderSelect("Penghasilan Wali", "penghasilanWali", PENDAPATAN_OPTIONS)}
            {renderSelect("Pendidikan Wali", "pendidikanWali", PENDIDIKAN_OPTIONS)}
          </div>
        </div>
      );
      case 3: return (
        <div className="animate-in fade-in slide-in-from-right-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            {renderInput("Nomor KKS / KPS", "kksKps", "text", "Nomor Kartu Kompensasi Sosial")}
            {renderInput("Nomor PKH", "pkh", "text", "Nomor Program Keluarga Harapan")}
            {renderInput("Nomor PIP", "pip", "text", "Nomor Program Indonesia Pintar")}
            {renderInput("Nomor KIP", "kip", "text", "Nomor Kartu Indonesia Pintar")}
            {renderSelect("Status Kepemilikan Rumah", "statusKepemilikanRumahOrangTua", ["Milik Sendiri", "Sewa/Kontrak", "Menumpang", "Rumah Dinas", "Lainnya"])}
          </div>
      ...
      case 4: return (
        <div className="animate-in fade-in slide-in-from-right-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5">
            {renderInput("Tahun Ajaran", "tahunAjaran")}
            {renderSelect("Jenis Lembaga", "jenisLembagaJenjang", ["SD", "MI", "Paket A", "Lainnya"])}
            {renderSelect("Status Sekolah", "statusSekolahAsal", ["Negeri", "Swasta"])}
            {renderInput("NPSN Sekolah Asal", "npsnSekolah")}
            {renderInput("Nama Sekolah Asal", "namaSekolahMadrasah")} 
            {renderInput("Lokasi Sekolah Asal", "lokasiSekolah")}
            ...
            {renderInput("Total Nilai UN", "totalNilaiUN")}
          </div>
        </div>
      );
      default: return null;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl px-4">
          <button onClick={() => setState(prev => ({ ...prev, viewMode: 'inden', currentStep: 'inden' }))} className="glass group p-12 rounded-[50px] border-maroon/30 hover:border-maroon hover:bg-maroon/10 transition-all text-left relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-3 text-maroon font-black text-[12px] tracking-widest uppercase bg-slate-900/50 w-fit px-5 py-2.5 rounded-full group-hover:bg-maroon group-hover:text-white transition-all">
                GAS DAFTAR <Icons.Sparkles />
              </div>
            </div>
          </button>
          ...
          <button onClick={() => setState(prev => ({ ...prev, viewMode: 'login' }))} className="glass group p-12 rounded-[50px] border-slate-800 hover:border-slate-600 transition-all text-left relative overflow-hidden">
             <div className="relative z-10">
              ...
              <div className="flex items-center gap-3 text-slate-400 font-black text-[12px] tracking-widest uppercase bg-slate-900/50 w-fit px-5 py-2.5 rounded-full group-hover:bg-slate-700 transition-all">
                ACCESS SYSTEM <Icons.Academic />
              </div>
            </div>
          </button>
        </div>
       ...
       <div id="print-area" className="max-w-[480px] w-full bg-white text-slate-900 p-10 rounded-[45px] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] text-left relative overflow-hidden print:shadow-none print:border print:border-slate-200">
          ...
          <div className="bg-slate-50 p-6 rounded-[35px] border border-slate-100 mb-8">
             ...
             <div className="flex gap-4">
                ...
                {state.studentData.fotoSiswa && (
                   <div className="w-24 h-32 rounded-xl overflow-hidden border border-slate-200 shadow-sm flex-shrink-0 bg-slate-200">
                      <img src={state.studentData.fotoSiswa} alt="Siswa" className="w-full h-full object-cover grayscale contrast-125" />
                   </div>
                )}
             </div>
  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-20 selection:bg-maroon selection:text-white">
      {/* Invisible file input for logo change */}
      <input 
        type="file" 
        ref={fileInputRef} 
        onChange={handleFileChange} 
      ...
      {/* Global Student Photo Input (Shared by Inden & Admin) */}
      <input 
        type="file" 
        ref={studentPhotoRef} 
      ...
      {deleteConfirm.show && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-950/80 backdrop-blur-md animate-in fade-in">
          <div className="glass p-10 rounded-[40px] border-maroon/30 max-w-sm w-full text-center shadow-2xl animate-in zoom-in-95 duration-300">
             <div className="w-16 h-16 bg-maroon/20 text-maroon rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Icons.Trash />
             </div>
      ...
      <nav className="p-6 sticky top-0 z-50 bg-slate-950/80 backdrop-blur-3xl border-b border-slate-900 no-print">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4 cursor-pointer group" onClick={safeExit}>
            <LogoComponent size="sm" interactive={state.viewMode === 'admin'} />
            <div className="text-left"><h1 className="font-black text-sm tracking-tighter uppercase leading-none group-hover:text-maroon transition-colors">MTsM 01 PBG</h1><p className="text-[9px] text-maroon font-black uppercase mt-1 tracking-widest">Bener, Pinter, Trampil</p></div>
          </div>
          <div className="flex items-center gap-6">
            ...
            <button onClick={safeExit} className="text-white font-black text-[10px] uppercase tracking-widest px-6 py-2.5 bg-slate-900 border border-slate-800 rounded-xl hover:bg-maroon hover:border-maroon transition-all">
              {state.viewMode === 'admin' ? 'LOGOUT' : 'EXIT FORM'}
            </button>
          </div>
        </div>
      </nav>
        ...
        <div className="glass rounded-[60px] p-8 md:p-16 border-maroon/10 shadow-2xl relative overflow-hidden">
          ...
          {state.viewMode === 'admin' && (
            <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-8 relative z-10">
              ...
              <div className="flex items-center gap-4">
                <span className="text-[10px] font-black text-slate-700 uppercase tracking-widest italic">ARCHIVE_FILTER:</span>
                <select className="bg-slate-950 border border-slate-900 text-[10px] font-black uppercase text-maroon rounded-xl px-5 py-3.5 focus:outline-none transition-all" value={state.selectedYear} onChange={(e) => setState(p => ({ ...p, selectedYear: e.target.value }))}>
          ...
          {state.viewMode === 'inden' ? (
            <div className="animate-in fade-in slide-in-from-bottom-8 max-w-6xl mx-auto relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                <div>
                  <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase text-white leading-[0.85] italic">FORMULIR<br/><span className="text-maroon">INDEN.SPMB</span></h2>
                  <p className="mt-4 text-slate-500 font-bold uppercase text-[11px] tracking-[0.3em] flex items-center gap-2">Secure your spot at the most sigma school <span className="w-1.5 h-1.5 bg-maroon rounded-full animate-ping"></span></p>
                </div>
                <div className="w-20 h-20 maroon-gradient rounded-3xl flex flex-col items-center justify-center font-black text-white shadow-[0_20px_40px_rgba(128,0,0,0.4)] rotate-3">
                  <span className="text-[10px] opacity-60">RANK</span>
                  <span className="text-2xl leading-none">#{state.studentData.noUrut}</span>
                </div>
              </div>
              
              <div className="bento-layout space-y-8">
                <div className="p-8 rounded-[45px] bg-slate-900/10 border border-slate-800/50">
                  {renderProgramCards()}
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="p-8 rounded-[45px] bg-slate-900/10 border border-slate-800/50 h-full">
                     <h4 className="text-[12px] font-black uppercase text-maroon mb-6 tracking-widest flex items-center gap-2">
                        A. IDENTITAS CALON SISWA <span className="h-px flex-1 bg-maroon/10"></span>
                     </h4>
                        ...
                        <div className={`w-32 h-32 rounded-full overflow-hidden border-2 ${isCameraOpen ? 'border-maroon animate-pulse' : 'border-slate-700 border-dashed'} flex flex-col items-center justify-center relative bg-slate-900/40`}>
                            {isCameraOpen ? (
                                ...
                                <div className="relative w-full h-full group">
                                    <img src={state.studentData.fotoSiswa} alt="Captured" className="w-full h-full object-cover" />
                                    <div onClick={retakePhoto} className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
                                        <span className="text-[9px] text-white font-black uppercase tracking-widest">AMBIL ULANG</span>
                                    </div>
                                </div>
                            ) : (
                                <div onClick={startCamera} className="flex flex-col items-center cursor-pointer group hover:opacity-80 transition-opacity">
                                    <Icons.User />
                                    <span className="text-[8px] mt-2 uppercase font-bold text-slate-500 group-hover:text-maroon transition-colors">Buka Kamera</span>
                                </div>
                            )}
                        </div>
                     </div>
                     {isCameraOpen && (
                        <div className="flex justify-center gap-2 mb-6">
                            <button onClick={stopCamera} className="px-3 py-1.5 rounded-full bg-slate-800 text-[9px] font-bold text-slate-400 hover:text-white uppercase tracking-wider">Batal</button>
                            <button onClick={capturePhoto} className="px-4 py-1.5 rounded-full bg-maroon text-[9px] font-bold text-white uppercase tracking-wider shadow-lg hover:brightness-110">Jepret!</button>
                        </div>
                     )}

                     <div className="space-y-4">
                        {renderInput("1. Nama Lengkap *", "namaSiswa", "text", "Sesuai Ijazah/Akta")}
                        {renderSelect("2. Jenis Kelamin *", "jenisKelamin", ["Laki-laki", "Perempuan"])}
                        {renderInput("3. NISN (10 Digit) *", "nisn", "text", "Cek di rapor SD/MI")}
                        {renderInput("4. Asal SD/MI *", "namaSekolahMadrasah", "text", "Nama sekolah asal")}
                        <div className="grid grid-cols-2 gap-4">
                            {renderInput("5. Tempat Lahir *", "tempatLahir", "text", "Kota lahir")}
                            {renderInput("Tanggal Lahir *", "tanggalLahir", "date")}
                        </div>
                     </div>
                  </div>

                  {/* Section B: Kontak Orang Tua / Wali */}
                  <div className="p-8 rounded-[45px] bg-slate-900/10 border border-slate-800/50 h-full">
                     <h4 className="text-[12px] font-black uppercase text-maroon mb-6 tracking-widest flex items-center gap-2">
                        B. KONTAK ORANG TUA / WALI <span className="h-px flex-1 bg-maroon/10"></span>
                     </h4>
                     
                     <div className="space-y-4">
                        {renderInput("1. Nama Ayah/Ibu/Wali *", "namaKepKeluarga", "text", "Nama orang tua atau wali")}
                        <div className="bg-maroon/5 p-4 rounded-2xl border border-maroon/20 mb-4">
                            {renderInput("2. No. WhatsApp Aktif *", "nomorTelepon", "tel", "08xxxxxx (Untuk Info Kelulusan)")}
                            <p className="text-[9px] text-maroon font-bold italic mt-[-10px]">*Pastikan nomor aktif WA</p>
                        </div>
              ...
              <button 
                ...
                className="group w-full maroon-gradient text-white py-7 rounded-[35px] font-black uppercase text-sm tracking-[0.4em] shadow-[0_25px_50px_rgba(128,0,0,0.4)] mt-12 transition-all active:scale-[0.97] hover:brightness-125 relative overflow-hidden"
              >
                <span className="relative z-10 flex items-center justify-center gap-4">
                  {state.isSubmitting ? 'PROCESSING_DATA...' : 'SUBMIT INDEN REQUEST'}
                  {!state.isSubmitting && <Icons.Sparkles />}
                </span>
                <div className="absolute top-0 left-[-100%] w-full h-full bg-white/10 group-hover:left-[100%] transition-all duration-1000 skew-x-12"></div>
              </button>
            </div>
          ) : adminSubView === 'form' ? (
            <div className="animate-in fade-in slide-in-from-right-8 max-w-6xl mx-auto relative z-10">
              <div className="flex justify-between items-center mb-12">
                <div>
                  <h3 className="text-4xl font-black text-white uppercase tracking-tighter italic">MASTER<span className="text-maroon">.EMIS</span>_ENTRY</h3>
                  <p className="text-[9px] font-black text-slate-700 uppercase tracking-[0.4em] mt-2">Section: {adminFormSections[adminFormStep]}</p>
                </div>
                <div className="flex gap-2">
                  {adminFormSections.map((_, idx) => (
                    <div key={idx} className={`h-1.5 rounded-full transition-all duration-700 ${idx === adminFormStep ? 'bg-maroon w-12' : idx < adminFormStep ? 'bg-maroon/30 w-6' : 'bg-slate-900 w-6'}`}></div>
                  ))}
                </div>
              </div>
              
              <div className="min-h-[450px] p-10 rounded-[45px] bg-slate-900/5 border border-slate-900"> 
                {renderAdminFormSection()} 
              </div>

              <div className="flex gap-6 mt-16 pt-10 border-t border-slate-900">
                {adminFormStep === 0 ? (
                  <button onClick={() => setAdminSubView('table')} className="flex-1 bg-slate-900 text-slate-500 py-5 rounded-[25px] font-black uppercase text-[10px] tracking-widest hover:text-white transition-all border border-slate-800">CANCEL_PROCESS</button>
                ) : (
                  <button onClick={() => setAdminFormStep(p => p - 1)} className="flex-1 bg-slate-900 text-slate-500 py-5 rounded-[25px] font-black uppercase text-[10px] tracking-widest hover:text-white transition-all border border-slate-800">BACK_PREV</button>
                )}
                {adminFormStep < adminFormSections.length - 1 ? (
                  <button onClick={handleNextStep} className="flex-[3] maroon-gradient text-white py-5 rounded-[25px] font-black uppercase text-xs tracking-widest shadow-2xl transition-all active:scale-[0.98] hover:brightness-110">CONTINUE_STEP</button>
                ) : (
                  <button onClick={handleSubmit} disabled={state.isSubmitting} className="flex-[3] maroon-gradient text-white py-5 rounded-[25px] font-black uppercase text-xs tracking-widest shadow-2xl transition-all active:scale-[0.98] hover:brightness-110">
                    {state.isSubmitting ? 'SAVING_MASTER_DATA...' : (state.editingIndex !== null ? 'UPDATE_DATABASE_RECORD' : 'COMMIT_DATABASE_ENTRY')}
                  </button>
                )}
              </div>
            </div>
            ...
            <div className="animate-in fade-in zoom-in-95 relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
                ...
                <div className="flex flex-wrap gap-4 w-full md:w-auto">
                  <div className="relative flex-1 md:w-72">
                    <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-700"><Icons.Sparkles /></span>
                    <input type="text" placeholder="FILTER_NAME_OR_NISN..." className="w-full bg-slate-950 border border-slate-900 text-white rounded-2xl pl-14 pr-6 py-4 text-[11px] font-black uppercase tracking-widest focus:outline-none focus:ring-1 focus:ring-maroon placeholder:text-slate-800" value={searchTerm} onChange={(e) => { setSearchTerm(e.target.value); setCurrentPage(1); }} />
                  </div>
              ...
              <div className="overflow-x-auto rounded-[40px] border border-slate-900 bg-slate-950/50 backdrop-blur-md">
                <table className="w-full text-left border-collapse">
                  <thead><tr className="border-b border-slate-900 bg-slate-950/80">
                    <th className="p-6 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em]">#NO</th>
                    <th className="p-6 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em] cursor-pointer hover:text-maroon group" onClick={() => setSortConfig({ key: 'namaSiswa', direction: sortConfig?.direction === 'asc' ? 'desc' : 'asc' })}>MASTER_NAME <span className="opacity-30 group-hover:opacity-100">{sortConfig?.key === 'namaSiswa' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : '↕'}</span></th>
                    <th className="p-6 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em]">NISN_ID</th>
                    <th className="p-6 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em]">TIER_SELECTED</th>
                    <th className="p-6 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em] text-center">CMD_CONTROL</th>
                  </tr></thead>
              ...
              {sortedData.length > itemsPerPage && (
                <div className="flex justify-between items-center mt-10 px-4">
                  ...
                  <div className="flex gap-3">
                    <button disabled={currentPage === 1} onClick={() => setCurrentPage(p => p - 1)} className="px-6 py-3 bg-slate-950 border border-slate-900 text-slate-600 rounded-xl text-[10px] font-black uppercase disabled:opacity-10 hover:text-white transition-all">PREV_SYS</button>
                    <button disabled={currentPage >= Math.ceil(sortedData.length / itemsPerPage)} onClick={() => setCurrentPage(p => p + 1)} className="px-6 py-3 bg-slate-950 border border-slate-900 text-slate-600 rounded-xl text-[10px] font-black uppercase disabled:opacity-10 hover:text-white transition-all">NEXT_SYS</button>
                  </div>
                </div>
              )}
            </div>
